...
Workflow per finding:
  ...
  5. Persist SecretValidation row (UPSERT)
  6. If any live secrets, bump finding severity and add tags
  7. Publish 'secret.validated' SSE event per validation row
  8. Return list of persisted SecretValidation rows
"""
...
from bounty.models import EvidencePackage, Finding, SecretValidation, severity_label
